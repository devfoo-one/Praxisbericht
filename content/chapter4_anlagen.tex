...
\end{compactitem}
Alle Elemente können wiederum durch Key-Value Paare, sogenannte \textit{Tags}, mit Eigenschaften versehen werden.
...
Eine Straße ist üblicherweise eine Verkettung aus \textit{Ways}.
\begin{figure}[htb]
  \centering
...
\end{figure}
Die Unterteilung einer Straße in mehrere Ways ist notwendig, da an einem Way-Element alle Daten des aktuellen Straßenabschnitts, wie z.B. Höchstgeschwindigkeit, durch \textit{Tags} gespeichert sind. 
...
\begin{figure}[htb]
  \centering
   ...
   \caption{Der Teilausschnitt besteht in den Daten aus zwei separaten Ways}
