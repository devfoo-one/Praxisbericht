...
Als kompliziertestes Problem stellte sich die Trennung zusammenhängender Way-Gruppen dar. In Abbildung~\ref{fig:ose:osm_streetgroups_1} ist ein Kartenausschnitt mit allen Ways mit dem Name \textit{``Berliner Straße''} dargestellt.

Wenn ich jetzt die nächste Abbildung \ref{fig:ose:osm_streetgroups_2} referenziere... was passiert dann? Und die nächste Abbildung \ref{fig:ose:uml} mit dem UML?
...
\begin{figure}[htb]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{gfx/osm_streetgroups_2.jpg}}
